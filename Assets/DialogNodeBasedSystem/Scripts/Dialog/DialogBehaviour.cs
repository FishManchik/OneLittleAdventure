...
namespace cherrydev
{
    public class DialogBehaviour : MonoBehaviour
    {
        ...
        private const string IconsScene = "IconsScene";
        ...
        public event Action<string, string, RenderTexture, RenderTexture, Node.IconType> OnSentenceNodeActiveWithParameter;
        ...
        private void Awake()
        {
            ...
            SceneManager.LoadScene(IconsScene, LoadSceneMode.Additive);
        }
        ...
        private void HandleSentenceNode(Node currentNode)
        {
            ...
            currentNodeGraph.blankPlayerIcon, currentNodeGraph.blankNpcIcon, sentenceNode.GetCharacterEnumIcon());
