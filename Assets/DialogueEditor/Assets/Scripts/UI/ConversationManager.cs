...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        public GameObject NpcCharacterIcon;
        ...
        private const string IsAppeared = "IsAppeared";
        ...
        private void SetupSpeech(SpeechNode speech)
        {
            ...
            if (speech.CharacterIcon != null)
            {
                Animator animator = speech.CharacterIcon.GetComponent<Animator>();
                animator.SetBool(IsAppeared, true);
            }

            bool isPlayer = speech.IsPlayerDialogue;
            NpcIcon.rectTransform.anchorMin = new Vector2(isPlayer ? 0 : 1, 0.5f);
            NpcIcon.rectTransform.anchorMax = new Vector2(isPlayer ? 0 : 1, 0.5f);
            NpcIcon.rectTransform.localScale = new Vector2(6.2f * (isPlayer ? 1 : -1), 6.2f);
            NpcIcon.rectTransform.anchoredPosition = new Vector2(isPlayer ? -60 : 60, 42);
            ...
            if (speech.Cutscene != null)
            {
                Director.playableAsset = speech.Cutscene;
                Director.Play(speech.Cutscene);
            }
