...
namespace cherrydev
{
    ...
    public class SentenceNode : Node
    {
        ...
        private const float externalNodeHeight = 175f;
        ...
        public Node.IconType GetCharacterEnumIcon()
        {
            return sentence.iconType;
        }

        public RenderTexture GetPlayerIcon()
        {
            return sentence.playerIcon;
        }
        public RenderTexture GetNpcIcon()
        {
            return sentence.npcIcon;
        }
        ...
        private void DrawCharacterIconHorizontal()
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUIUtility.labelWidth = 50f; sentence.iconType = (Node.IconType)EditorGUILayout.EnumPopup("Select Option", sentence.iconType); EditorGUIUtility.labelWidth = 0f;
            EditorGUILayout.EndHorizontal();
