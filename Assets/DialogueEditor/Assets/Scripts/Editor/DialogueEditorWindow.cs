            ...
            else
            {
                ...
                if (CurrentlySelectedObject.Type == SelectableUI.eType.Node)
                {
                    ...
                    if (selectedNode is UISpeechNode)
                    {
                        ...
                        node.CharacterIcon = (GameObject)EditorGUILayout.ObjectField(node.CharacterIcon, typeof(GameObject), false, GUILayout.ExpandWidth(true));
                        EditorGUILayout.Space();

                        GUILayout.Label("RectTransform Options");
                        node.IsPlayerDialogue = EditorGUILayout.Toggle("Icon display option", node.IsPlayerDialogue);
                        EditorGUILayout.Space();
                        ...
                        GUILayout.Label("Cutscene Options", EditorStyles.boldLabel);
                        GUILayout.Label("Cutscene");
                        node.Cutscene = (PlayableAsset)EditorGUILayout.ObjectField(node.Cutscene, typeof(PlayableAsset), false, GUILayout.ExpandWidth(true));
                        EditorGUILayout.Space();
                    ...
                    else if (selectedNode is UIOptionNode)
                    {
                        ...
                        GUILayout.Label("Cutscene", EditorStyles.boldLabel);
                        node.Cutscene = (PlayableAsset)EditorGUILayout.ObjectField(node.Cutscene, typeof(PlayableAsset), false);
                        EditorGUILayout.Space();
