...
namespace DialogueEditor
{
    ...
    public class EditableSpeechNode : EditableConversationNode
    {
        ...
        [DataMember] public string CharacterIconGUID;
        ...
        [DataMember] public bool IsPlayerDialogue;
        ...
        public override void SerializeAssetData(NPCConversation conversation)
        {
            ...
            conversation.GetNodeData(this.ID).CharacterIcon = this.CharacterIcon;
            conversation.GetNodeData(this.ID).Cutscene = this.Cutscene;
        }
        ...
        public override void DeserializeAssetData(NPCConversation conversation)
        {
            ...
            this.CharacterIcon = conversation.GetNodeData(this.ID).CharacterIcon;
            this.Cutscene = conversation.GetNodeData(this.ID).Cutscene;
            ...
            if (conversation.Version < (int)eSaveVersion.V1_03)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(CharacterIconGUID))
                    {
                        string path = UnityEditor.AssetDatabase.GUIDToAssetPath(CharacterIconGUID);
                        this.CharacterIcon = (GameObject)UnityEditor.AssetDatabase.LoadAssetAtPath(path, typeof(GameObject));
                    }
                }
            }
#endif
    ...
    [DataContract]
    public class EditableCutsceneNode : EditableConversationNode
    {
        public EditableCutsceneNode() : base()
        {
        ...
        public PlayableAsset Cutscene;
        [DataMember] public string CutsceneGUID;
